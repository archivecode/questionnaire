<x-app-layout>
    <form method="POST" action="{{ route('feedback.customer.store') }}">
        @csrf
        <h1 class="mt-2 mb-10 font-weight-bolder pb-2 border-b-2"><strong>Add Customer Feedback</strong></h1>
            ...
            <label for="developer" class="ml-5">Select Developer</label>
